...
#
# Script generated by Vivado on Fri Dec 19 13:49:44 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : design_final.sh
...
#
# Usage        : design_final.sh
#                design_final.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_final.sh [-reset_run]
#                design_final.sh [-reset_log]
#                design_final.sh [-help]
#
...
#                script (type 'design_final.sh -help' for more information).
#
...
# script info
echo -e "design_final.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_final.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../proyectoFinal.gen/sources_1/bd/design_final/ipshared/30ef" +incdir+"$ref_dir/../../../../proyectoFinal.gen/sources_1/bd/design_final/ipshared/ec67/hdl" +incdir+"../../../../proyectoFinal.gen/sources_1/bd/design_final/ipshared/30ef" +incdir+"../../../../proyectoFinal.gen/sources_1/bd/design_final/ip/design_final_vga_0_0/src/clk_ip_core" +incdir+"../../../../proyectoFinal.gen/sources_1/bd/design_final/ipshared/ec67/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.design_final xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.design_final -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log design_final_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_final.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_final.sh [-help]\n\
Usage: design_final.sh [-step]\n\
Usage: design_final.sh [-lib_map_path]\n\
Usage: design_final.sh [-reset_run]\n\
Usage: design_final.sh [-reset_log]\n\
Usage: design_final.sh [-keep_index]\n\
Usage: design_final.sh [-noclean_files]\n\n\
