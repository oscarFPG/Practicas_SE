...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.design_final xil_defaultlib.glbl -o design_final_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./design_final_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key design_final_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc design_final_simv.daidir vcs_lib c.obj)
