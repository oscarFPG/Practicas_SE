...
#
# Script generated by Vivado on Wed Nov 19 17:28:46 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : design_4.sh
...
#
# Usage        : design_4.sh
#                design_4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_4.sh [-reset_run]
#                design_4.sh [-reset_log]
#                design_4.sh [-help]
#
...
#                script (type 'design_4.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname microblaze_v11_0_11 -libname lmb_v10_v3_0_12 -libname lmb_bram_if_cntlr_v4_0_22 -libname blk_mem_gen_v8_4_6 -libname axi_lite_ipif_v3_0_4 -libname mdm_v3_2_24 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname generic_baseblocks_v2_1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_28 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_crossbar_v2_1_29 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib microblaze_v11_0_11 lmb_v10_v3_0_12 lmb_bram_if_cntlr_v4_0_22 blk_mem_gen_v8_4_6 axi_lite_ipif_v3_0_4 mdm_v3_2_24 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_28 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "design_4.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" \
  ...
  xmvlog -work generic_baseblocks_v2_1_0 $xmvlog_opts +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" \
  ...
  xmvlog -work fifo_generator_v13_2_8 $xmvlog_opts +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" \
  ...
  xmvlog -work axi_data_fifo_v2_1_27 $xmvlog_opts +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" \
  "../../../../Practica4.gen/sources_1/bd/design_4/ipshared/fab7/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_29 $xmvlog_opts +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"$ref_dir/../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/30ef" +incdir+"../../../../Practica4.gen/sources_1/bd/design_4/ipshared/ec67/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.design_4 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.design_4 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log design_4_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_4.sh [-help]\n\
Usage: design_4.sh [-step]\n\
Usage: design_4.sh [-lib_map_path]\n\
Usage: design_4.sh [-reset_run]\n\
Usage: design_4.sh [-reset_log]\n\
Usage: design_4.sh [-keep_index]\n\
Usage: design_4.sh [-noclean_files]\n\n\
