...
##Keypad
#Entradas
set_property PACKAGE_PIN K3 [get_ports {R_0[3]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {R_0[3]}]
set_property PACKAGE_PIN L3 [get_ports {R_0[2]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {R_0[2]}]
set_property PACKAGE_PIN M3 [get_ports {R_0[1]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {R_0[1]}]
set_property PACKAGE_PIN M2 [get_ports {R_0[0]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {R_0[0]}]

#Salidas
set_property PACKAGE_PIN K2 [get_ports {S_0[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S_0[3]}]
set_property PACKAGE_PIN J2 [get_ports {S_0[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S_0[2]}]
set_property PACKAGE_PIN H2 [get_ports {S_0[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {S_0[1]}]
set_property PACKAGE_PIN G2 [get_ports {S_0[0]}]					
