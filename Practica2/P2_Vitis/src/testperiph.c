...
int main () 
{
   ...
   COPRO_mWriteReg(XPAR_COPRO_0_S00_AXI_BASEADDR, COPRO_S00_AXI_SLV_REG0_OFFSET, 7);
   ...
   COPRO_mWriteReg(XPAR_COPRO_0_S00_AXI_BASEADDR, COPRO_S00_AXI_SLV_REG3_OFFSET, 15);
   ...
   while(1){
	   ...
	   xil_printf("Dato del reg0: %d\n\r", reg0);
	   xil_printf("Dato del reg1: %d\n\r", reg1);
	   xil_printf("Dato del reg2: %d\n\r", reg2);
	   xil_printf("Dato del reg3: %d\n\r", reg3);
	   xil_printf("---\n\r");
