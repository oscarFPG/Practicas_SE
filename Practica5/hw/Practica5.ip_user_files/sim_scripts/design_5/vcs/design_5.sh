...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Practica5.gen/sources_1/bd/design_5/ipshared/30ef" +incdir+"../../../../Practica5.gen/sources_1/bd/design_5/ipshared/30ef" +incdir+"../../../../Practica5.gen/sources_1/bd/design_5/ip/design_5_vga_0_4/src/clk_ip_core" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Practica5.gen/sources_1/bd/design_5/ipshared/30ef" +incdir+"../../../../Practica5.gen/sources_1/bd/design_5/ipshared/30ef" +incdir+"../../../../Practica5.gen/sources_1/bd/design_5/ip/design_5_vga_0_4/src/clk_ip_core" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Practica5.gen/sources_1/bd/design_5/ipshared/30ef" +incdir+"../../../../Practica5.gen/sources_1/bd/design_5/ipshared/30ef" +incdir+"../../../../Practica5.gen/sources_1/bd/design_5/ip/design_5_vga_0_4/src/clk_ip_core" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.design_5 xil_defaultlib.glbl -o design_5_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./design_5_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key design_5_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc design_5_simv.daidir vcs_lib c.obj)
