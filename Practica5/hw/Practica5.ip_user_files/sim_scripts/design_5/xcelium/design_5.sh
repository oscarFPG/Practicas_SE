...
#
# Script generated by Vivado on Wed Dec 03 17:01:36 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : design_5.sh
...
#
# Usage        : design_5.sh
#                design_5.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_5.sh [-reset_run]
#                design_5.sh [-reset_log]
#                design_5.sh [-help]
#
...
#                script (type 'design_5.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname microblaze_v11_0_11 -libname xil_defaultlib -libname lmb_v10_v3_0_12 -libname lmb_bram_if_cntlr_v4_0_22 -libname blk_mem_gen_v8_4_6 -libname axi_lite_ipif_v3_0_4 -libname mdm_v3_2_24 -libname generic_baseblocks_v2_1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_28 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_crossbar_v2_1_29 -libname lib_pkg_v1_0_2 -libname lib_srl_fifo_v1_0_2 -libname lib_cdc_v1_0_2 -libname axi_uartlite_v2_0_32 -libname proc_sys_reset_v5_0_13 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm microblaze_v11_0_11 xil_defaultlib lmb_v10_v3_0_12 lmb_bram_if_cntlr_v4_0_22 blk_mem_gen_v8_4_6 axi_lite_ipif_v3_0_4 mdm_v3_2_24 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_28 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29 lib_pkg_v1_0_2 lib_srl_fifo_v1_0_2 lib_cdc_v1_0_2 axi_uartlite_v2_0_32 proc_sys_reset_v5_0_13)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "design_5.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_5.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../Practica5.gen/sources_1/bd/design_5/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Practica5.gen/sources_1/bd/design_5/ipshared/30ef" +incdir+"../../../../Practica5.gen/sources_1/bd/design_5/ipshared/ec67/hdl" +incdir+"../../../../Practica5.gen/sources_1/bd/design_5/ipshared/30ef" +incdir+"../../../../Practica5.gen/sources_1/bd/design_5/ip/design_5_vga_0_4/src/clk_ip_core" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.design_5 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.design_5 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log design_5_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_5.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_5.sh [-help]\n\
Usage: design_5.sh [-step]\n\
Usage: design_5.sh [-lib_map_path]\n\
Usage: design_5.sh [-reset_run]\n\
Usage: design_5.sh [-reset_log]\n\
Usage: design_5.sh [-keep_index]\n\
Usage: design_5.sh [-noclean_files]\n\n\
